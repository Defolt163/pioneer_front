...
export default function RegisterPage() {
  ...
  const handleGetCode = () => {
    ...
    setTimeout(() => setShowSmsPopup(false), 3000)
  }
    ...
    <div className="page-enter" style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', background: '#fff' }}>
      ...
      {showSmsPopup && (
        <div className="scale-in" style={{
          ...
          background: '#1a1f36', color: '#fff', padding: '14px 28px',
          borderRadius: '14px', zIndex: 100, textAlign: 'center',
          boxShadow: '0 8px 32px rgba(0,0,0,0.35)',
        }}>
          <div style={{ fontSize: '11px', opacity: 0.6, marginBottom: '6px', letterSpacing: '0.08em', textTransform: 'uppercase' }}>
            SMS на номер {phone}
          </div>
          <div style={{ fontSize: '28px', fontWeight: 700, letterSpacing: '0.35em' }}>
            {DEMO_CODE}
          </div>
        </div>
      )}
